			...
			<Auth>
				...
				<form className="mt-6">
					...
					<div className="flex flex-col my-4">
						...
						<input type="password" className="w-[90%] h-[2.5em] tracking-wider duration-150 mt-1 m-auto rounded border border-zinc-500 bg-transparent pl-2 text-sm focus:ring-zinc-300" />
					</div>
					<div className="flex flex-col">
						<button
							type="submit"
						...
						<p className="font-intertight tracking-wider font-zinc-200 text-xs ml-[5%] mt-1">
							...
							<Link href="/register">
								<p className="inline cursor-pointer duration-150 text-[#1f8083] hover:text-[#1ea0a5]"> Sign Up</p>
							</Link>
						</p>
					</div>
				</form>
