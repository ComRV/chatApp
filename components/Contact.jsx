const Contact = () => {
	return (
		<div className={`basis-[100%] md:basis-[35%] lg:basis-[21%] flex flex-col border-r border-r-[#3b3b3b]`}>
			...
			/>
			<div>
				<div className="grid grid-cols-5 grid-rows-2 pt-1 pb-2  overflow-auto scrollbar-none text-zinc-200 font-intertight tracking-wider hover:bg-[#323232d3] cursor-pointer duration-100">
